...
[요청]
팀장이 이 상황을 단정하지 않고 팀원과 성과대화를 나눌 수 있도록 대화 흐름과 질문을 작성해주세요.

[조건]
1. 팀원의 노력을 인정하되 성과 책임이 흐려지지 않게 해주세요.
2. 원인을 단정하지 말고 선택한 원인 가설을 확인하는 방식으로 질문을 구성해주세요.
3. 실제 고객명, 병원명, 의료진명, 제품명, 내부자료는 포함하지 마세요.
4. 팀원이 방어적으로 듣지 않도록 표현을 부드럽게 하되, 다음 행동 약속은 분명하게 해주세요.
5. 팀원에게만 책임을 넘기지 말고 팀장 지원도 포함해주세요.
  ...
  return (
    <>
      ...
      <p className="subtitle">
        선택한 상황, 원인 가설, 익명화된 상황 설명을 바탕으로 성과대화 준비용 프롬프트를 생성합니다.
      </p>
